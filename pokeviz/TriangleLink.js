...
go.Diagram.inherit(TriangleLink, go.Link);

/**
* @ignore
* Copies properties to a cloned TriangleLink.
* @this {TriangleLink}
* @param {TriangleLink} copy
* @override
*/
TriangleLink.prototype.cloneProtected = function(copy) {
...
* @name TriangleLink#base
* @function.
* @return {number}
*/
Object.defineProperty(TriangleLink.prototype, "base", {
...
* @this {TriangleLink}
*/
TriangleLink.prototype.makeGeometry = function() {
...
* @this {TriangleLink}
*/
TriangleLink.prototype.pathToCorner = function(side, bb, fig, pos, L, R) {
  switch (side % 4) {
